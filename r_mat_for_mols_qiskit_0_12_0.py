    ...
    if MoleculeFlag == 'H2':
        ...
        if is_atomic:
            try:
                ...
                driver = PySCFDriver(atom='H 0 0 -0.3707; H 0 0.0 0.3707', unit=UnitsType.ANGSTROM, charge=0, spin=0, basis='sto3g')
                molecule = driver.run()
            ...
            driver = PySCFDriver(atom='H 0 0 -0.3707; H 0 0.0 0.3707', unit=UnitsType.ANGSTROM,
    ...
    #=================================
        ...
        if is_atomic:
            try:
                ...
                driver = PySCFDriver(atom='O 0.0 0.0 0.0;H 1 0 0; H -1.0 0.0 0.0',
    ...
    #=================================
        ...
        if is_atomic:
            try:
                ...
                driver = PySCFDriver(atom='C -0.6000 0.0000 0.0000; C 0.6000 0.0000 0.0000; H -1.6650 0.0000 0.000; H 1.6650 0.0000 0.000',
                         unit=UnitsType.ANGSTROM, charge=0, spin=0, basis='sto3g')
                molecule = driver.run()
                one_b=QMolecule.onee_to_spin(molecule.hcore)
                two_b=QMolecule.twoe_to_spin(molecule.eri)
